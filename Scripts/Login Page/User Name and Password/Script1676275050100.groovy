...
WebUI.setText(findTestObject('CURA Healthcare Service/Login Page/editbox_username'), Username)

WebUI.setText(findTestObject('CURA Healthcare Service/Login Page/editbox_password'), Password)

WebUI.delay(1)

WebUI.click(findTestObject('CURA Healthcare Service/Login Page/btn_login'))
